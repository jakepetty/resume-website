...
<section class="container">
    ...
    <div class="btn-group float-right">
        <a href="{{ route('experiences.create') }}" class="btn btn-outline-dark">
    ...
    <table class="table table-borderless table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form class="form-inline float-right" action="{{ route('experiences.destroy', $experience->id) }}"
                        method="POST"
                        onsubmit="return confirm('{{ __('Are you sure you want to delete this experience?') }}')">
                        @csrf @method('DELETE')
                        <div class="btn-group">
                            <a class="btn btn-outline-dark btn-sm" href="{{ route('experiences.edit', $experience->id) }}">
