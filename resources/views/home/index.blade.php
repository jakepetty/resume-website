                    ...
                    <div class="content text-left">
                        <div class="row">
                            @foreach($skills as $skill)
                                <div class="skill">
                                    <div class="name">
                                        <span class="fa-stack fa-1x d-none d-lg-inline-block">
                                            <i class="fas fa-circle fa-stack-2x"></i>
                                            <i class="fas fa-check fa-stack-1x fa-inverse"></i>
                                        </span> {{ $skill->name }}
                                        <span class="badge badge-accent d-none d-xl-inline-block">{{ $skill->end_date - $skill->start_date }} {{ $skill->end_date - $skill->start_date > 1 ? 'years':'year' }}</span>
                                    </div>
                                </div>
                            @endforeach
                        </div>
